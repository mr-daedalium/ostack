<!-- Agent Companies Standard — Skill definition location: skills/<skill-name>/SKILL.md -->
<!-- This is the Agent Companies standard location for skill definitions. -->
<!-- The content below is an exact copy of the root SKILL.md. -->
---
name: ostack
version: 1.1.0
description: |
